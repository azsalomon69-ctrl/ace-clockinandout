...
function openWorkspaceHelp(isAdmin) {
    const entries = isAdmin ? [
        ...
        ['Where do I see invitations?', 'Open People → Invitations to review pending invitations, resend when available, or cancel an invitation that is no longer needed.'],
        ...
        ['How do I manage users?', 'Open People → Users. Use Manage on the user’s row to update their role, status, department, or other available account details.'],
        ...
        ['How do I create or edit a department?', 'Open People → Departments. Add a department, edit its name or description, and keep employee assignments organized from the user-management area.'],
        ['How do I create a project?', 'Open Work → Projects, choose Add project, enter the name and details, then save. Keep inactive projects out of new work when they are finished.'],
        ['How do I assign people to a project?', 'Open Work → Projects, open the project’s management options, and assign the relevant employees. Assigned projects are available to employees when they clock in.'],
        ['How do I create a schedule?', 'Open Work → Schedule & flextime. Create a fixed or flextime schedule, set the work days and break limit, then assign it to the relevant employees.'],
        ...
        ['How do I view or correct time entries?', 'Open Work → Time entries. Filter by date, employee, project, or status, open a record, and use Correct time only to fix a genuine timekeeping error.'],
        ['How do I handle an employee who forgot to clock out?', 'Open Work → Time entries, locate the active session, review it with the employee, then use the available time-entry management action to close or correct it accurately.'],
        ['Where are deleted time entries?', 'Open Work → Deleted time entries. Review removed records there and restore only entries that should return to the active history.'],
        ['How do I add a remark to a time entry?', 'Open the employee’s time-entry details from Work → Time entries and add the administrator remark. The employee can read it in Work → Remarks.'],
        ...
        ['How do I generate a report?', 'Use Generate report on the dashboard, or open Insights → Reports for saved reports. Choose the report details and date range, then export when ready.'],
        ['Where do I find one employee’s report?', 'Open Insights → Individual reports, choose the employee and dates, then generate or review the individual report.'],
        ...
        ['How do I update my own account or appearance?', 'Open Administration → Settings, then use Profile, Security, or Appearance. You can also open your account menu in the sidebar and choose Profile & settings.'],
        ...
        ['Why can I not clock in?', 'Check whether you already have an active session, whether a project assignment is required, and whether your account is active. If the problem continues, contact an administrator.'],
        ...
        ['How do I choose a project when clocking in?', 'During Clock in, select one of your assigned projects. If the project you need is missing, ask an administrator to assign you to it.'],
        ...
        ['What does my schedule mean?', 'Your Dashboard shows any assigned schedule. Fixed schedules show expected start and end times; flextime shows the required daily time and break limit.'],
        ...
        ['Why is a project missing?', 'Only projects assigned to you are available for work. Ask an administrator to assign the project or confirm that it is active.'],
        ['How do I request access or fix a denied account?', 'If you cannot access the workspace, contact an administrator. They can review your access request or account status from the People area.'],
        ['How do I sign out?', 'Open your account menu and choose Log out. Always clock out of your work session first if you have finished for the day.'],
