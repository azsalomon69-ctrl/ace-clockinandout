...
window.ACETutorialConfig = {
    ...
    ADMIN: {
        ...
        steps: [
            ...
            { page: 'projects.html', target: '#sectionAction', title: 'Set up projects', body: 'Create projects employees can select while tracking time. Edit a project to add employees directly, or assign it from the employee’s Users → Manage panel.', navigation: { group: 'Work', label: 'Projects' } },
