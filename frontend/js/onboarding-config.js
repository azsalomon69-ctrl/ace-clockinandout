...
window.ACETutorialConfig = {
    ...
    ADMIN: {
        ...
        steps: [
            ...
            { page: 'admin-time-entries.html', target: '#sectionSearch', title: 'Review team time entries', body: 'Search entries and use the employee, project, and remarks filters to find a record. This view includes active entries, completed work and administrator remarks.', navigation: { group: 'Work', label: 'Time entries' } },
