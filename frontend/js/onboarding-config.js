...
window.ACETutorialConfig = {
    ...
    ADMIN: {
        ...
        steps: [
            ...
            { page: 'export-audit.html', target: '#exportAuditRows', title: 'Review data exports', body: 'Export audit records which administrator exported time data, when, the file format, and the selected date range. Use it to keep sensitive data handling accountable.', navigation: { group: 'Administration', label: 'Export audit' } },
