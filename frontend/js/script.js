...
function workspaceHelpEntries(isAdmin) {
    return isAdmin ? [
        ...
        ['Where can I review exports?', 'Open Administration → Export audit. It records the administrator, time, format, and date range for Time Entries exports. Saved report exports are also recorded in the main Audit log.'],
