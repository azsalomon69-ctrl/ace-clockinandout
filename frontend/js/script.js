...
function workspaceHelpEntries(isAdmin) {
    return isAdmin ? [
        ...
        ['How do I assign a person to a project?', 'Open Work → Projects, choose Edit on the project, then use Add employee. You can also use People → Users → Manage → Project assignment. The project then appears as an optional choice when that employee clocks in.'],
